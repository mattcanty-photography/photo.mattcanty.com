...
func newHomePageInstance(s *live.Socket) *homePageInstance {
	...
	if !ok {
		flowers, err := ioutil.ReadFile("images/flowers.jpg")
		if err != nil {
			fmt.Println("Err")
		}
		cat, err := ioutil.ReadFile("images/cat.jpg")
		if err != nil {
			fmt.Println("Err")
		}
		door, err := ioutil.ReadFile("images/door.jpg")
		if err != nil {
			fmt.Println("Err")
		}
			...
			Portfolios: []portfolio{
				{
					...
					Base64Image:     base64.StdEncoding.EncodeToString(flowers),
				},
				{
					ID:              live.NewID(),
					...
					AlternativeText: "A black and white cat casting a distinctive shadow.",
					Title:           "Cats",
					Description:     "Who doesn't love cats?",
					Base64Image:     base64.StdEncoding.EncodeToString(cat),
				},
				{
					ID:              live.NewID(),
					...
					AlternativeText: "A red door with white vertical stripes.",
					Title:           "Doors",
					...
					Base64Image:     base64.StdEncoding.EncodeToString(door),
				},
			},
		}
	}
